package com.minecraftserverzone.harrypotter.spells;
...
public abstract class ModAbstractHurtingProjectile extends Projectile {
   public double xPower;
   public double yPower;
   public double zPower;

   protected ModAbstractHurtingProjectile(EntityType<? extends ModAbstractHurtingProjectile> p_36833_, Level p_36834_) {
      super(p_36833_, p_36834_);
   }

   public ModAbstractHurtingProjectile(EntityType<? extends ModAbstractHurtingProjectile> p_36817_, double p_36818_, double p_36819_, double p_36820_, double p_36821_, double p_36822_, double p_36823_, Level p_36824_) {
   ...
   public ModAbstractHurtingProjectile(EntityType<? extends ModAbstractHurtingProjectile> p_36826_, LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
   ...
   public ModAbstractHurtingProjectile(EntityType<? extends ModAbstractHurtingProjectile> p_36826_, Entity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
	      this(p_36826_, p_36827_.getX(), p_36827_.getY(), p_36827_.getZ(), p_36828_, p_36829_, p_36830_, p_36831_);
	      this.setOwner(p_36827_);
	      this.setRot(p_36827_.getYRot(), p_36827_.getXRot());
	   }
