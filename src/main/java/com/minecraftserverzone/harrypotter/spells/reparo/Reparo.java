...
public class Reparo extends PullSpell {
	public Reparo(EntityType<? extends Reparo> p_37364_, Level p_37365_) {
		super(p_37364_, p_37365_);
	}

	public Reparo(Level p_37375_, LivingEntity p_37376_, double p_37377_, double p_37378_, double p_37379_) {
		super(Registrations.REPARO.get(), p_37376_, p_37377_, p_37378_, p_37379_, p_37375_);
	}
	...
	public Reparo(Level p_37367_, double p_37368_, double p_37369_, double p_37370_, double p_37371_,
			double p_37372_, double p_37373_) {
		super(Registrations.REPARO.get(), p_37368_, p_37369_, p_37370_, p_37371_, p_37372_, p_37373_, p_37367_);
	}
		...
		for(ItemEntity itementity : itemEntitiesNear) {
            if (!itementity.isRemoved() && !itementity.getItem().isEmpty() && !itementity.hasPickUpDelay()) {
               if(itementity.getItem().isDamageableItem()) {
            	   if(itementity.getItem().isDamaged()) {
//            		   int getMaxDamage = itementity.getItem().getMaxDamage();
//            		   int damage = itementity.getItem().getDamageValue();
