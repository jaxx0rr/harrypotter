...
public class BroomStick extends LivingEntity {
            ...
            if (this.isVehicle() && this.canBeControlledByRider()) {
                ...
                if (this.isControlledByLocalInstance()) {
                    ...
                    if (this.getSpeed() != 0) {
                        ...
                        this.getAttribute(Attributes.FLYING_SPEED).setBaseValue(0.1D);
                        setSpeed(0.1f);
                    } else {
                        f1 += flyingSpeed;
                        this.getAttribute(Attributes.FLYING_SPEED).setBaseValue(0.01D);
                    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 1.0D).add(Attributes.MOVEMENT_SPEED, (double) 0.0F).add(Attributes.FLYING_SPEED, 0.1D);
    }
}
